...
/**
 * Monta uma estrutura de arvore para os itens do menu do wordpress
 * @param array $elements Array plano com os elementos do menu
 * @param int $parentId ID do pai, usado para recursividade
 * @return array Array formatado em estrutura de arvore
 */
