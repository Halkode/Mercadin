...
<html data-wf-domain="https://developer.wordpress.com/docs/" data-wf-page="60365ca71791199c516b1762" data-wf-site="603649186bcfc27fa69d2755" data-wf-status="1">
...
<head>
    ...
    <link href="<?php echo $GLOBALS['archives'].'css/docs-theme.css'; ?>" rel="stylesheet" type="text/css" />
    ...
    <link href="<?php echo $GLOBALS['archives'].'img/logo.png'; ?>" rel="shortcut icon" type="image/x-icon" />
        ...
        <div class="container">
            <div class="header-flex">
                <a href="<?php echo home_url().'/docs'; ?>" class="header-brand">
                    <img
                        src="<?php echo $GLOBALS['archives'].'img/logo.png'; ?>"
